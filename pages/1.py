...
st.write("첫 시간 교수님의 질문: 수학 서술형 평가의 답안을 교사가 분석하여 학생들의 성취 지식과 함께 교과 역량에 대한 맞춤형 평가를 할 수 있다고 생각하시나요? 그것을 위해 필요한 것은 무엇일까요?")
st.write("저희 조는 위 질문의 해답을 이번 프로젝트의 기획 의도로 보았습니다.")
