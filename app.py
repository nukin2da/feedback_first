...
st.subheader("문항 1-8")
st.markdown("저장 매체의 용량을 나타내는 단위로 $B, KB, MB$ 등이 있고, $1KB=2^10B, 1MB=2^10KB$이다. 찬혁이가 컴퓨터로 용량이 $36MB$인 자료를 내려받으려고 한다. 이 컴퓨터에서 1초당 내려받는 자료의 용량이 $9\times 2^20B$일 때, 찬혁이가 자료를 모두 내려받는 데 몇 초가 걸리는지 구하시오.")
